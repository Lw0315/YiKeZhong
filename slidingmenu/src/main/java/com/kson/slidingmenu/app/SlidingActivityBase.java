...
public interface SlidingActivityBase {
	 ...
	 * com.example.asus.yikezhong.view are ignored. Both the width and the height of the com.example.asus.yikezhong.view are set by default to MATCH_PARENT. To use your
	 * own layout parameters, invoke setContentView(android.com.example.asus.yikezhong.view.View, android.com.example.asus.yikezhong.view.ViewGroup.LayoutParams) instead.
	 *
	 * @param view The desired content to display.
	 */
