...
import com.example.asus.yikezhong.adapter.MyAdapter_A;
...
public class Fragment_ShiPin extends Fragment {
    ...
    private MyAdapter_A maa;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=View.inflate(getActivity(), R.layout.fragment_shipin,null);
        initview();
        initdata();
    ...
    private void initview() {
        ...
        maa=new MyAdapter_A(getChildFragmentManager());
        vp.setAdapter(maa);
