...
public class ImageCrile extends ImageView {
    ...
    public ImageCrile(Context context) {
        this(context, null);
    }

    public ImageCrile(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageCrile(Context context, AttributeSet attrs, int defStyle) {
